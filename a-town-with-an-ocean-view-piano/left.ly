...
left = \relative c {
  ...
  % ここからDメロ
  \bar "||"
  e'8-5[(b'-. -3) <e-2 g-5>-. b-. -3] a,-5[(e'-. -3)] c'16-. -1[b-. -2 a-. -3 g-. -4]

  d8-5[(a'-. -3) <d-2 fis-1>-. a-. -3] g,-5[(d'-. -3)] b'16-. -1[a-. -2 g-. -3 fis-. -4]

  c8-5[(g'-. -3) <c-2 e-1>-. g-. -3] fis,-5[(c'-. -3)] a'16-. -1[g-. -2 fis-. -3 e-. -4]

  b8-5[(fis'-. -3) <a-2 dis-1>-. fis-. -3] e-5[(g-. -3)] b16-. -1[a-. -2 g-. -3 fis-. -4]

  e8-5[(b'-. -3) <e-2 g-1>-. b-. -3] a,-5[(e'-. -3)] c'16-. -1[b-. -2 a-. -3 g-. -4]
